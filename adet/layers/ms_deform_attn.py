...
class MSDeformAttn(nn.Module):
    ...
    def forward(self, query, reference_points, input_flatten, input_spatial_shapes, input_level_start_index,
        ...
        sampling_offsets = self.sampling_offsets(query+pred_attentions if pred_attentions is not None else query).view(N, Len_q, self.n_heads, self.n_levels, self.n_points, 2)
